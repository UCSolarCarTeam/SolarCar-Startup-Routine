...
class Domovoi:
    ...
    def parse_file(self, processes_file): #opens processes_file which should contain a list of paths to each Solar Car Processes, and makes an object for each one.
...
def main():
    ...
    domovoi = Domovoi()
    domovoi.run(args.processes_file)#Uses the argument stored earlier to run the program. 
